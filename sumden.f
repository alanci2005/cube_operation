...
C      real*8 Tdoexp, Todexp, Tabexp
	...
	real*8 sqr2, cA, cB ! coefficients in linear combination
...
C      calctime = TIMEF()      !This line for Win32
	...
	OPEN (unit = 16, file='coefficient', err=999)
	read(16,*) cA, cB
	write(*,*)cA, cB
	close(16)
C
...
C  Atomic number, charge and atomic positions
	...
	sqr2=DSQRT(2.d0)
      do i1=1,NA1
        do i2=1,NA2
	    do i3 = 1,NA3
c	      density(i3) = qA(i3,i2,i1)*qB(i3,i2,i1)*sqr2 !*VolA !mo2den
	      density(i3) = cA*qA(i3,i2,i1)+cB*qB(i3,i2,i1) ! sumden
c	      write(*,*) density(i3)
	    enddo
